...
namespace SalesTrackerAPI.DAL
{
    public class TblOtherTaxesDAO
    {
        ...
        #region Selection
        public static List<TblOtherTaxesTO> SelectAllTblOtherTaxes()
        {
        ...
        public static TblOtherTaxesTO SelectTblOtherTaxes(Int32 idOtherTax)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static List<TblOtherTaxesTO> ConvertDTToList(SqlDataReader tblOtherTaxesTODT)
        {
        ...
        public static int ExecuteInsertionCommand(TblOtherTaxesTO tblOtherTaxesTO, SqlCommand cmdInsert)
        {
        ...
        public static int ExecuteUpdationCommand(TblOtherTaxesTO tblOtherTaxesTO, SqlCommand cmdUpdate)
        {
        ...
        public static int ExecuteDeletionCommand(Int32 idOtherTax, SqlCommand cmdDelete)
        {
