...
namespace SalesTrackerAPI.DAL
{
    public class TblOverdueDtlDAO
    {
        ...
        #region Selection
        public static List<TblOverdueDtlTO> SelectAllTblOverdueDtl()
        {
        ...
        public static List<TblOverdueDtlTO> SelectAllTblOverdueDtl(String dealerIds)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static TblOverdueDtlTO SelectTblOverdueDtl(Int32 idOverdueDtl)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static List<TblOverdueDtlTO> ConvertDTToList(SqlDataReader tblOverdueDtlTODT)
        {
        ...
        public static int ExecuteInsertionCommand(TblOverdueDtlTO tblOverdueDtlTO, SqlCommand cmdInsert)
        {
...
" VALUES (" +
        ...
        public static int ExecuteUpdationCommand(TblOverdueDtlTO tblOverdueDtlTO, SqlCommand cmdUpdate)
        {
        ...
        public static int ExecuteDeletionCommand(Int32 idOverdueDtl, SqlCommand cmdDelete)
        {
