...
{
    public class TblAlertInstanceDAO
    {
        #region Methods
        ...
        #region Selection
        public static List<TblAlertInstanceTO> SelectAllTblAlertInstance()
        {
        ...
        public static List<TblAlertInstanceTO> SelectAllTblAlertInstance(Int32 userId, Int32 roleId)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static TblAlertInstanceTO SelectTblAlertInstance(Int32 idAlertInstance)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static List<TblAlertInstanceTO> ConvertDTToList(SqlDataReader tblAlertInstanceTODT)
        {
        ...
        public static int ExecuteInsertionCommand(TblAlertInstanceTO tblAlertInstanceTO, SqlCommand cmdInsert)
        {
        ...
        public static int ResetAutoResetAlertInstances(SqlConnection conn, SqlTransaction tran)
        {
            SqlCommand cmdUpdate = new SqlCommand();
            try
            {
        ...
        public static int ResetAlertInstance(int alertDefId,int sourceEntityId, int userId, SqlConnection conn, SqlTransaction tran)
        {
            ...
            try
            {
                ...
                String sqlQuery = "";
                if (userId == 0){
                    sqlQuery = @" UPDATE [tblAlertInstance] SET " +
                                  " [isActive]= 0" +
                                  " WHERE [alertDefinitionId] = @AlertDefinitionId AND sourceEntityId=@SourceEntityId ";
                }else {
                    sqlQuery = @"UPDATE AI
                        SET AI.isActive = 0
                        FROM tblAlertInstance AI
                        JOIN tblAlertUsers AU ON AI.idAlertInstance = AU.alertInstanceId
                        WHERE AI.alertDefinitionId = @AlertDefinitionId and AI.sourceEntityId = @SourceEntityId and AU.userId = @UserId";
                }
                ...
                if(userId != 0)
                cmdUpdate.Parameters.Add("@UserId", System.Data.SqlDbType.Int).Value = userId;
                return cmdUpdate.ExecuteNonQuery();
            }
            catch (Exception ex)
            {
        ...
        public static int ExecuteUpdationCommand(TblAlertInstanceTO tblAlertInstanceTO, SqlCommand cmdUpdate)
        {
            String sqlQuery = @" UPDATE [tblAlertInstance] SET " +
                            "  [raisedBy]= @RaisedBy" +
        ...
        public static int ExecuteDeletionCommand(Int32 idAlertInstance, SqlCommand cmdDelete)
        {
