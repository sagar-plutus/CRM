...
{
    public class TblRateDeclareReasonsDAO
    {
        #region Methods
        public static String SqlSelectQuery()
        {
            String sqlSelectQry = " SELECT * FROM [tblRateDeclareReasons]"; 
            return sqlSelectQry;
        }
        #endregion

        #region Selection
        public static List<TblRateDeclareReasonsTO> SelectAllTblRateDeclareReasons()
        {
        ...
        public static TblRateDeclareReasonsTO SelectTblRateDeclareReasons(Int32 idRateReason)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static List<TblRateDeclareReasonsTO> ConvertDTToList(SqlDataReader tblRateDeclareReasonsTODT)
        {
        ...
        public static int ExecuteInsertionCommand(TblRateDeclareReasonsTO tblRateDeclareReasonsTO, SqlCommand cmdInsert)
        {
        ...
        public static int ExecuteUpdationCommand(TblRateDeclareReasonsTO tblRateDeclareReasonsTO, SqlCommand cmdUpdate)
        {
        ...
        public static int ExecuteDeletionCommand(Int32 idRateReason, SqlCommand cmdDelete)
        {
