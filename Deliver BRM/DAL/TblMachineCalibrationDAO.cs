...
{
    public class TblMachineCalibrationDAO
    {
        #region Methods
        ...
        public static TblMachineCalibrationTO SelectTblMachineCalibration(Int32 idMachineCalibration)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static List<TblMachineCalibrationTO> SelectAllTblMachineCalibration(SqlConnection conn, SqlTransaction tran)
        {
            SqlCommand cmdSelect = new SqlCommand();
            try
            {
        ...
        public static TblMachineCalibrationTO SelectTblMachineCalibrationByWeighingMachineId(Int32 weighingMachineId)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static List<TblMachineCalibrationTO> ConvertDTToList(SqlDataReader tblMachineCalibrationTODT)
        {
        ...
        #region Insertion
        public static int InsertTblMachineCalibration(TblMachineCalibrationTO tblMachineCalibrationTO)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
        ...
        public static int ExecuteInsertionCommand(TblMachineCalibrationTO tblMachineCalibrationTO, SqlCommand cmdInsert)
        {
            ...
            cmdInsert.Parameters.Add("@UpdatedOn", System.Data.SqlDbType.DateTime).Value = Constants.ServerDateTime;
        ...
        public static int ExecuteUpdationCommand(TblMachineCalibrationTO tblMachineCalibrationTO, SqlCommand cmdUpdate)
        {
        ...
        public static int ExecuteDeletionCommand(Int32 idMachineCalibration, SqlCommand cmdDelete)
        {
