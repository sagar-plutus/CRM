...
namespace SalesTrackerAPI.DAL
{
    public class TblPagesDAO
    {
        ...
        #region Selection
        public static List<TblPagesTO> SelectAllTblPages()
        {
        ...
        public static List<TblPagesTO> SelectAllTblPages(int moduleId)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static TblPagesTO SelectTblPages(Int32 idPage)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static List<TblPagesTO> ConvertDTToList(SqlDataReader tblPagesTODT)
        {
        ...
        public static int ExecuteInsertionCommand(TblPagesTO tblPagesTO, SqlCommand cmdInsert)
        {
...
" VALUES (" +
        ...
        public static int ExecuteUpdationCommand(TblPagesTO tblPagesTO, SqlCommand cmdUpdate)
        {
        ...
        public static int ExecuteDeletionCommand(Int32 idPage, SqlCommand cmdDelete)
        {
