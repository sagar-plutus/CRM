...
{
    public class TblProductInfoDAO
    {
        #region Methods
        ...
        #region Selection
        public static List<TblProductInfoTO> SelectAllTblProductInfo()
        {
        ...
        public static List<TblProductInfoTO> SelectTblProductInfoLatest()
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static List<TblProductInfoTO> SelectAllTblProductInfo(SqlConnection conn,SqlTransaction tran)
        {
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static List<TblProductInfoTO> SelectAllLatestProductInfo(SqlConnection conn, SqlTransaction tran)
        {
            SqlCommand cmdSelect = new SqlCommand();
            SqlDataReader sqlReader = null;
            try
            {
                cmdSelect.CommandText = SqlSelectQuery() +
                                       "  INNER JOIN " +
                                       "  ( " +
                                       "  SELECT materialId, prodCatId, prodSpecId, MAX(createdOn) createdOn " +
                                       "  FROM tblProductInfo " +
                                       "   GROUP BY materialId, prodCatId, prodSpecId " +
                                       "  ) latest_info " +
                                       "  ON latest_info.materialId = product.materialId " +
                                       "  AND latest_info.prodCatId = product.prodCatId " +
                                       "  AND latest_info.prodSpecId = product.prodSpecId " +
        ...
        public static TblProductInfoTO SelectTblProductInfo(Int32 idProduct)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static List<TblProductInfoTO> SelectEmptyProductDetailsTemplate(int prodCatId)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
            ...
            try
            {
                ...
                cmdSelect.CommandText = " SELECT idProdCat AS prodCatId, prodCateDesc, prodSpec.idProdSpec AS prodSpecId,prodSpecDesc, idMaterial AS materialId,materialSubType,  " +
                                        ...
                                        "    INNER JOIN " +
                                        "    ( " +
                                        "       SELECT prodCatId, materialId, prodSpecId, MAX(createdOn) createdOn " +
                                        "        FROM tblProductInfo loadingQuota " +
                                        "        GROUP BY prodCatId, materialId, prodSpecId " +
                                        "    ) latestProd " +
        ...
        public static List<TblProductInfoTO> SelectProductInfoListByLoadingSlipExtIds(string strLoadingSlipExtIds)
        {
            ...
            public static List<TblProductInfoTO> ConvertReaderToList(SqlDataReader tblStockDetailsTODT)
        {
        ...
        public static List<TblProductInfoTO> ConvertDTToList(SqlDataReader tblProductInfoTODT)
        {
        ...
        public static int ExecuteInsertionCommand(TblProductInfoTO tblProductInfoTO, SqlCommand cmdInsert)
        {
        ...
        public static int ExecuteUpdationCommand(TblProductInfoTO tblProductInfoTO, SqlCommand cmdUpdate)
        {
        ...
        public static int ExecuteDeletionCommand(Int32 idProduct, SqlCommand cmdDelete)
        {
