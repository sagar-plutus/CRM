...
namespace SalesTrackerAPI.DAL
{
    public class TblOrgAddressDAO
    {
        ...
        #region Selection
        public static List<TblOrgAddressTO> SelectAllTblOrgAddress()
        {
        ...
        public static TblOrgAddressTO SelectTblOrgAddress(Int32 idOrgAddr)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static List<TblOrgAddressTO> ConvertDTToList(SqlDataReader tblOrgAddressTODT)
        {
        ...
        public static int ExecuteInsertionCommand(TblOrgAddressTO tblOrgAddressTO, SqlCommand cmdInsert)
        {
        ...
        public static int ExecuteUpdationCommand(TblOrgAddressTO tblOrgAddressTO, SqlCommand cmdUpdate)
        {
        ...
        public static int ExecuteDeletionCommand(Int32 idOrgAddr, SqlCommand cmdDelete)
        {
