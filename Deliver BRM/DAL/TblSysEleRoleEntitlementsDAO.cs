...
{
    public class TblSysEleRoleEntitlementsDAO
    {
        #region Methods
        ...
        public static Dictionary<int, String> SelectAllTblSysEleMultipleRoleEntitlementsDCT(String roleId, int? moduleId)
        {
            ...
            try
            {
                string query = SqlSelectQuery();
                if (moduleId != null)
                    query = query + " LEFT JOIN tblSysElements sysele on tblSysEleRoleEntitlements.sysEleId = sysele.idSysElement ";
                conn.Open();
                cmdSelect.CommandText = query + " WHERE roleId IN (" + roleId + ")";
                if (moduleId != null)
                    cmdSelect.CommandText = cmdSelect.CommandText +
                        " and sysele.moduleId=" + moduleId;
                ...
                while (tblSysEleRoleEntitlementsTODT.Read())
                {
                    ...
                    {
                        if (!sysEleDCT.ContainsKey(sysEleId))
                            sysEleDCT.Add(sysEleId, permission);
                        else
                        {
                            if (permission != Constants.NotApplicable)
                            {
                                String currentPer = sysEleDCT[sysEleId];
                                if (currentPer == Constants.NotApplicable)
                                {
                                    sysEleDCT[sysEleId] = permission;
                                }
                            }
                        }
                    }
        ...
        public static List<TblSysEleRoleEntitlementsTO> SelectAllTblSysEleRoleEntitlements(int roleId)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static Dictionary<int, String> SelectAllTblSysEleRoleEntitlementsDCT(Int32 roleId)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static TblSysEleRoleEntitlementsTO SelectTblSysEleRoleEntitlements(Int32 idRoleEntitlement, Int32 roleId, Int32 sysEleId, String permission)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static TblSysEleRoleEntitlementsTO SelectRoleSysEleUserEntitlements(Int32 roleId, Int32 sysEleId, SqlConnection conn, SqlTransaction tran)
        {
            SqlCommand cmdSelect = new SqlCommand();
            SqlDataReader rdr = null;
            try
        ...
        public static List<TblSysEleRoleEntitlementsTO> ConvertDTToList(SqlDataReader tblSysEleRoleEntitlementsTODT)
        {
        ...
        public static Dictionary<int, String> SelectAllTblSysEleMultipleRoleEntitlementsDCT(String roleId)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
            ...
            {
                conn.Open();
                cmdSelect.CommandText = SqlSelectQuery() + " WHERE roleId IN (" + roleId + ")";
                cmdSelect.Connection = conn;
                cmdSelect.CommandType = System.Data.CommandType.Text;
        ...
        public static int ExecuteInsertionCommand(TblSysEleRoleEntitlementsTO tblSysEleRoleEntitlementsTO, SqlCommand cmdInsert)
        {
        ...
        public static int ExecuteUpdationCommand(TblSysEleRoleEntitlementsTO tblSysEleRoleEntitlementsTO, SqlCommand cmdUpdate)
        {
        ...
        public static int ExecuteDeletionCommand(Int32 idRoleEntitlement, Int32 roleId, Int32 sysEleId, String permission, SqlCommand cmdDelete)
        {
