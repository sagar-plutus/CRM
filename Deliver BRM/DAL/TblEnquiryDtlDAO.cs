...
namespace SalesTrackerAPI.DAL
{
    public class TblEnquiryDtlDAO
    {
        ...
        #region Selection
        public static List<TblEnquiryDtlTO> SelectAllTblEnquiryDtl()
        {
        ...
        public static List<TblEnquiryDtlTO> SelectEnquiryDtlList(Int32 organizationId)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static List<TblEnquiryDtlTO> ConvertDTToList(SqlDataReader tblEnquiryDtlTODT)
        {
        ...
        public static TblEnquiryDtlTO SelectOrganizationEnquiryDtl(string enqRefId)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static int DeactivateOrgEnqDeatls(Int32 idEnquiryDtl, SqlConnection conn, SqlTransaction tran)
        {
        ...
        public static int ExecuteInsertionCommand(TblEnquiryDtlTO tblEnquiryDtlTO, SqlCommand cmdInsert)
        {
...
" VALUES (" +
        ...
        public static int ExecuteUpdationCommand(TblEnquiryDtlTO tblEnquiryDtlTO, SqlCommand cmdUpdate)
        {
            String sqlQuery = @" UPDATE [tblEnquiryDtl] SET " +
        ...
        public static int ExecuteDeletionCommand(Int32 idEnquiryDtl, SqlCommand cmdDelete)
        {
