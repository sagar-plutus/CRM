...
{
    public class TblOtherSourceDAO
    {
        #region Methods
        ...
        #region Selection
        public static List<TblOtherSourceTO> SelectAllTblOtherSource()
        {
        ...
        public static TblOtherSourceTO SelectTblOtherSource(Int32 idOtherSource)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static List<TblOtherSourceTO> ConvertDTToList(SqlDataReader tblOtherSourceTODT)
        {
        ...
        public static int ExecuteInsertionCommand(TblOtherSourceTO tblOtherSourceTO, SqlCommand cmdInsert)
        {
        ...
        public static int ExecuteUpdationCommand(TblOtherSourceTO tblOtherSourceTO, SqlCommand cmdUpdate)
        {
        ...
        public static int ExecuteDeletionCommand(Int32 idOtherSource, SqlCommand cmdDelete)
        {
