...
{
    public class TblMenuStructureDAO
    {
        #region Methods
        ...
        #region Selection
        public static List<TblMenuStructureTO> SelectAllTblMenuStructure()
        {
        ...
        public static TblMenuStructureTO SelectTblMenuStructure(Int32 idMenu)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static List<TblMenuStructureTO> ConvertDTToList(SqlDataReader tblMenuStructureTODT)
        {
        ...
        public static int ExecuteInsertionCommand(TblMenuStructureTO tblMenuStructureTO, SqlCommand cmdInsert)
        {
...
" VALUES (" +
        ...
        public static int ExecuteUpdationCommand(TblMenuStructureTO tblMenuStructureTO, SqlCommand cmdUpdate)
        {
        ...
        public static int ExecuteDeletionCommand(Int32 idMenu, SqlCommand cmdDelete)
        {
