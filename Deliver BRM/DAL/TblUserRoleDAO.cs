...
{
    public class TblUserRoleDAO
    {
        #region Methods
        public static String SqlSelectQuery()
        {
            String sqlSelectQry = " SELECT userRole.*, role.roleDesc,role.enableAreaAlloc,role.roleTypeId  FROM [tblUserRole] userRole" +
        ...
        #region Selection
        public static List<TblUserRoleTO> SelectAllTblUserRole()
        {
            ...
            {
                conn.Open();
                cmdSelect.CommandText = SqlSelectQuery() + " WHERE userRole.isActive=1";
        ...
        public static List<TblUserRoleTO> SelectAllActiveUserRole(Int32 userId)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        /// <returns></returns>
        public static List<TblUserRoleTO> SelectAllActiveUserRole(Int32 userId,SqlConnection conn,SqlTransaction tran)
        {
            SqlCommand cmdSelect = new SqlCommand();
            SqlDataReader sqlReader = null;
            try
        ...
        public static TblUserRoleTO SelectTblUserRole(Int32 idUserRole)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static Int32 IsAreaAllocatedUser(Int32 userId)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static List<DropDownTO> SelectUsersFromRoleForDropDown(Int32 roleId)
        {
            ...
            {
                conn.Open();
                String aqlQuery = " SELECT idUser,userDisplayName,UserExt.personId FROM tblUser " +
                ...
                while (dateReader.Read())
                {
                    ...
                    if (dateReader["personId"] != DBNull.Value)
                        dropDownTONew.Tag = Convert.ToString(dateReader["personId"].ToString()); //Sudhir[30-7-2018]  Added for Get PersonId
        ...
        public static List<DropDownTO> SelectUsersFromRoleIdsForDropDown(string roleId)
        {
            ...
            try
            {
                ...
                String aqlQuery = " SELECT idUser,userDisplayName FROM tblUser " +
                                  " INNER JOIN tblUserRole ON userId = idUser " +
                                  " WHERE tblUser.isActive=1 AND roleId IN(" + roleId + ")";
        ...
        public static List<TblUserRoleTO> ConvertDTToList(SqlDataReader tblUserRoleTODT)
        {
            ...
            if (tblUserRoleTODT != null)
            {
                while (tblUserRoleTODT.Read())
                {
                    ...
                    if (tblUserRoleTODT["roleTypeId"] != DBNull.Value)
                        tblUserRoleTONew.RoleTypeId = Convert.ToInt32(tblUserRoleTODT["roleTypeId"].ToString());
        ...
        public static int ExecuteInsertionCommand(TblUserRoleTO tblUserRoleTO, SqlCommand cmdInsert)
        {
        ...
        public static int ExecuteUpdationCommand(TblUserRoleTO tblUserRoleTO, SqlCommand cmdUpdate)
        {
        ...
        public static int ExecuteDeletionCommand(Int32 idUserRole, SqlCommand cmdDelete)
        {
