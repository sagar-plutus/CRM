...
{
    public class DimPageElementTypesDAO
    {
        #region Methods
        ...
        #region Selection
        public static List<DimPageElementTypesTO> SelectAllDimPageElementTypes()
        {
        ...
        public static DimPageElementTypesTO SelectDimPageElementTypes(Int32 idPageEleType)
        {
            String sqlConnStr = Startup.ConnectionString;
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public static List<DimPageElementTypesTO> ConvertDTToList(SqlDataReader dimPageElementTypesTODT)
        {
        ...
        public static int ExecuteInsertionCommand(DimPageElementTypesTO dimPageElementTypesTO, SqlCommand cmdInsert)
        {
...
" VALUES (" +
        ...
        public static int ExecuteUpdationCommand(DimPageElementTypesTO dimPageElementTypesTO, SqlCommand cmdUpdate)
        {
        ...
        public static int ExecuteDeletionCommand(Int32 idPageEleType, SqlCommand cmdDelete)
        {
